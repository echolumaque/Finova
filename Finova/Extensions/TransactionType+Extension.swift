...
extension Category {
    ...
    static func getPredefinedTransactions(in context: NSManagedObjectContext) -> [Category] {
        ...
        let predefinedCategories: [(name: String, details: String, cashflowType: CashflowType, logo: String)] = [
            ...
            // Mixed
            ("Internal Transfers",
             "Movement of funds between your own accounts (e.g., checking ↔ savings).",
             .both,
             "arrow.left.arrow.right.circle.fill"),
            ("Loan Payments",
             "Payments toward loan principal and interest.",
             .both,
             "dollarsign.circle.fill"),
            ("Savings Contributions / Withdrawals",
             "Deposits into or withdrawals from savings accounts.",
             .both,
             "building.columns"),
            ("Investment Purchases / Sales",
             "Buying or selling stocks, bonds, or other investment vehicles.",
             .both,
             "chart.bar.fill"),
            ("Fees & Charges",
             "Bank fees, brokerage commissions, or service charges.",
             .both,
             "creditcard.fill"),
            ("Currency Exchange",
             "Gains or losses resulting from converting one currency to another.",
             .both,
             "dollarsign.arrow.circlepath"),
            ("Adjustments & Corrections",
             "Manual tweaks made to correct errors or reconcile balances.",
             .both,
             "wrench.fill"),
            ("Taxes Paid / Withheld",
             "Payments made for income, property, or other taxes (or withholding entries).",
             .both,
             "percent"),
            ("Charitable Donations / Grants Received",
             "Money donated to charities or grants awarded to you.",
             .both,
             "heart.circle.fill"),
            ("Accruals & Prepayments",
             "Recording of expenses or income allocated over future periods.",
             .both,
